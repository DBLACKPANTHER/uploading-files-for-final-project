...
# === Safe model path (place .keras model in same folder as app.py or adjust path below) ===
MODEL_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), 
                            r"C:\Users\yahav\Downloads\workprojvi\final_project stuff\projectResults\age_model_vgg16.keras")
